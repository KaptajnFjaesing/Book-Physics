...
% Fallback for Dirac slash notation used in the physics chapters
\usepackage{slashed}  % keep this

\makeatletter
\renewcommand{\slashed}[1]{%
	\mathchoice
	{\ooalign{$\hfil\displaystyle\m@th/\hfil$\crcr$\displaystyle\m@th#1$}}
	{\ooalign{$\hfil\textstyle\m@th/\hfil$\crcr$\textstyle\m@th#1$}}
	{\ooalign{$\hfil\scriptstyle\m@th/\hfil$\crcr$\scriptstyle\m@th#1$}}
	{\ooalign{$\hfil\scriptscriptstyle\m@th/\hfil$\crcr$\scriptscriptstyle\m@th#1$}}
}
\makeatother
\newcommand{\dbar}{\mathchar'26\mkern-12mu d}

% Packages used by the QFT/Feynman content
\usepackage{tikz}
